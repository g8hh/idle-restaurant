...
var cnItems = {
    ...
    "Novelty Bonus": "新颖性奖励",
    "Comfort Villa": "舒适别墅",
    "Choose one perk": "选择一项福利",
    "Gain": "获得",
    "to fastfood dishes income.": "到快餐菜肴的收入。",
    " really ": " 真的 ",
    "to dessert dishes income.": "到甜品菜肴收入。",
    "to vegan dishes income.": "到素食菜肴收入。",
    " Perks": "福利",
    "All the possibilities there are, all the combinations there could be!": "所有的可能性，所有的组合！",
    "Better learn to keep track of it and employ it to make even better restaurants!": "最好学会跟踪它并利用它来打造更好的餐厅！",
    "Better make it meal of the day!": "最好让它成为一天中的一餐！",
    "Even your visitors notice that!": "甚至您的访客也会注意到这一点！",
    "Food + dessert + drink = perfect balance.": "食物+甜点+饮料=完美平衡。",
    "For science!": "为了科学！",
    "for your new ideas in the culinary world.": "为您在烹饪界的新想法。",
    "Now it's time for some experimenting!": "现在是进行一些实验的时候了！",
    "Since people are visiting restaurants to have a full meal": "由于人们去餐馆吃一顿正餐",
    "Those starter cafes will provide perfect test subjects": "那些入门咖啡馆将提供完美的测试对象",
    "why highlight only one dish of the day?": "为什么只强调一天中的一道菜？",
    "You feel inspired when you try new restaurant categories.": "当您尝试新的餐厅类别时，您会受到启发。",
    "You recently came up with a great idea": "你最近想出了一个好主意",
    "\"Dish of the day\" banner will do just that.": "“当日菜肴”横幅就可以做到这一点。",
    "\"Reading blogs and scrolling endless feeds of photos is not just slacking off.": "\“阅读博客和滚动无休止的照片提要不仅仅是懈怠。",
    "\"Variety is the spice of life\", as the common saying goes.": "“品种是生活的调味品”，俗话说得好。",
    "1st dish: not drink, not dessert": "第一道菜：不喝酒，不甜点",
    "2nd dish: dessert": "第二道菜：甜点",
    "3rd dish: drink": "第三道菜：饮料",
    "Bonus from dish of the day: x2": "每日菜肴奖励：x2",
    "Choose a new perk on every Tier Up.": "在每次升级时选择一个新特权。",
    "Does not replace current Meal of the Day dishes.": "不取代当前的每日一餐菜肴。",
    "dessert": "甜点",
    "drink": "饮料",
    "Gain bonuses to less used food categories for the next prestige.": "为下一个声望获得较少使用的食物类别的奖金。",
    "Halve the amount of time for getting a coupon.": "获得优惠券的时间减半。",
    "Hard Reset (right click or long hold": "硬重置（右键单击或长按",
    "Highlights the main meal of your restaurant to give it triple income.": "突出您餐厅的主餐，为其带来三倍收入。",
    "https://discord.gg/rEgC33c": "https://discord.gg/rEgC33c",
    "main dish (not dessert or drink": "主菜（不是甜点或饮料",
    "Meal consists of": "膳食包括",
    "Million $": "百万 $",
    "More on Info/Restaurant tab.": "更多信息/餐厅标签。",
    "MotD": "MotD",
    "Overrides Dish of the Day bonus": "覆盖当日佳肴奖励",
    "Spend them to boost time on Prestige.": "花费它们来增加在 Prestige 上的时间。",
    "This is (currently) the final skill of the game.": "这是（目前）游戏的最终技能。",
    "Tier 2 and 3 starters": "2 级和 3 级启动器",
    "to meat dishes income.": "以荤菜收入。",
    "to premium dishes income.": "以溢价菜收入。",
    "Warning: you have a duplicate dish in your restaurant. Duplicates don't provide additional bonuses, so it is usually better to merge them.": "警告：您的餐厅有重复的菜肴。 重复不会提供额外的奖励，因此通常最好将它们合并。",
    "Warning: your Meal of the Day is not active. Requirements for activation": "警告：您的每日一餐未激活。 激活要求",
    "Highlights the main dish of your restaurant to give it double income.": "突出您餐厅的主菜，使其获得双倍收入。",
    "just to see how you would manage them.": "只是看看你将如何管理它们。",
    "Next: Fortune Paper every 25 Supercooks for money": "下一篇： 每 25 个超级厨师赚钱的财富纸业",
    "Now even renowned restaurant owners offer you their restaurants to manage.": "现在，即使是著名的餐厅老板也为您提供他们的餐厅来管理。",
    "Now you can also swap them out during the game": "现在你也可以在游戏中换掉它们",
    "Now you start the Season 2 with": "现在你开始第 2 季",
    "Only works for restaurants, not deliveries": "仅适用于餐厅，不适用于外卖",
    "Precise Science": "精密科学",
    "Prestige Points in Season 1.": "第 1 赛季的声望点数。",
    "Prestige Points.": "声望点。",
    "Prestige tab": "威望标签",
    "Prolonged Delivery": "延长交货",
    "Reading random books, blog posts and articles about food could provide some good learning.": "随机阅读有关食物的书籍、博客文章和文章可以提供一些很好的学习。",
    "rename": "改名",
    "s and Megacooks will now": "s 和 Megacooks 现在将",
    "Science will no longer be random.": "科学将不再是随机的。",
    "Season 1 Bonus": "第 1 季奖金",
    "SEASON 2 HAS ARRIVED!": "第 2 季已经到来！",
    "So in order to continue, we need to get back to where we left.": "所以为了继续，我们需要回到我们离开的地方。",
    "some of them even want to give you their restaurants": "他们中的一些人甚至想给你他们的餐馆",
    "Super Sort": "超级排序",
    "There is a lot of new stuff in the game now. Make sure to check out new skills on": "现在游戏中有很多新东西。确保检查新技能",
    "There is also an Option to auto-place Buffs.": "还有一个自动放置增益的选项。",
    "They trust you so much they are giving you full control.": "他们非常信任你，他们让你完全控制。",
    "They will not regret it!": "他们不会后悔的！",
    "This is totally not just a way for the dev to incentivise": "这完全不仅仅是开发者激励的一种方式",
    "Triple Cook": "三重厨师",
    "Waves Refuge": "海浪避难所",
    "When delivery runs out, it will not stop. It will keep working for unlimited time, but with 40% of the effect.": "当交货用完时，它不会停止。它将无限期地持续工作，但有 40% 的效果。",
    "Whenever you press the Sort button, all the highlighted dishes from your kitchen will get automatically placed into your restaurant.": "每当您按下排序按钮时，厨房中所有突出显示的菜肴都会自动放入您的餐厅。",
    "with exactly 3 dishes in each category (no more, no less).": "每个类别中正好有 3 道菜（不多也不少）。",
    "Works for deliveries too!": "也适用于送货！",
    "You also get a permanent": "您还可以获得永久",
    "You can temporarily put whatever you want in that slot - the first slot of Meal of the Day.": "您可以暂时将您想要的任何东西放入该插槽 - 每日一餐的第一个插槽。",
    "You have earned": "你赚了",
    "you to try making other restaurant setups": "您尝试制作其他餐厅设置",
    "A table-sized plate will let you add more exotic flavors to your dishes.": "一个餐桌大小的盘子可以让您为您的菜肴添加更多异国风味。",
    "Add tier 2 and 3 dishes to starter restaurants and ability to swap them out any time.": "将第 2 层和第 3 层菜肴添加到入门餐厅，并且可以随时更换它们。",
    "Adds a free drink to your deliveries (in a modern recyclable bottle).": "为您的送货添加免费饮料（在现代可回收瓶中）。",
    "Adds a mode to cook 6 times in one click.": "添加一键烹饪 6 次的模式。",
    "Advanced": "先进的",
    "Also add a free toy in there.": "还在那里添加一个免费玩具。",
    "always": "总是",
    "and not just the same one you've been doing all this time": "而不仅仅是你一直在做的那个",
    "And that big umbrella in the center of the table could now double as a food decoration.": "桌子中央的那把大伞现在可以兼作食物装饰品。",
    "bonus to all income.": "所有收入的奖金。",
    "Can't get screwed by Science": "不能被科学搞砸",
    "Change your main categories every prestige to get bigger bonus.": "更改每个声望的主要类别以获得更大的奖金。",
    "Choose a new perk on every Tier Up.": "在每次升级时选择一个新特权。",
    "Complimentary Drink": "免费饮品",
    "cook at least one stack of the first dish in your restaurant.": "在你的餐厅里至少煮一叠第一道菜。",
    "Coupon": "优惠券",
    "Don't want people to call it \"Sad Meal\" after all!": "毕竟不希望人们称它为“悲伤的一餐”！",
    "Food + dessert + drink. Perfect balance.": "食物+甜点+饮料。完美的平衡。",
    "Gain access to Tier 4 Perks.": "获得第 4 层福利。",
    "Galaxy Things": "星系物品",
    "(You can temporarily put whatever you want in that slot - the first slot of Meal of the Day.": "（您可以暂时将您想要的任何东西放入该插槽 - 每日一餐的第一个插槽。",
    "Spend them to boost time on Prestige.": "花费它们来增加在 Prestige 上的时间。",
    "Your": "你的",
    "click here": "点击这里",
    "Come take a look!": "快来看看吧！",
    "Git游戏": "Git游戏",
    "on Discord": "在不和谐",
    "Today is our weekly": "今天是我们的每周",
    "\"Nice Food Pics Day\"": "“美食图片日”",
    "Up to get Perks.": "提升以获得福利。",
    "your Meal of the Day is not active. Requirements for activation": "您的“每日一餐”未启用。 激活要求",
    " Buffs": "爱好者",
    " categories: 2/8": "  类别：2/8",
    " Challenges": "  挑战",
    " Charity": "  慈善机构",
    " Dish of the Day": "  今日例菜",
    " Double Cook": "  双厨师",
    ...
    " Science": "  科学",
    " Starting Restaurants": " 初始餐厅",
    " Triple Cook": "  三重厨师",
    ": +20": ": +20",
    "... probably.": "... 大概。",
    "\"Variety is the spice of life\", as the old saying goes.": "古语有云，“百花齐放”。",
    "": "",
    "": "",
    "": "",
    "": "",
    ...
    //原样
    'QQ群号': 'QQ群号',
    'r/restaurantidle/': 'r/restaurantidle/',
    'Reddit: ': 'Reddit: ',
    'https://www.reddit.com/r/restaurantidle/': 'https://www.reddit.com/r/restaurantidle/',
    'x': 'x',
    'X': 'X',
    '': '',
    '': '',
...
var cnPrefix = {
    ...
    "Bonus from perks:": "来自福利的奖励：",
    "Bonus from Season ": "赛季奖励 ",
    "(vegan - dessert -": "（素食 - 甜点 -",
    "Currently Starter Dish ": "当前开胃菜 ",
    "to set as Starter Dish ": "以设置为开胃菜 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Cook \((\d+) left$/, '烹饪 （$1 剩余'],
    [/^Cook (.+) times for the price of (.+) coupons.$/, '以 $1 优惠券的价格烹饪 $2 次。'],
    [/^You get (.+) permanent income bonus$/, '您将获得 $1 的永久收入奖励'],
    [/^Get (.+) total Prestige Points$/, '总共获得 $1 声望点'],
    [/^(.+)Tier 2 and 3 starters and ability to replace them in the menu$/, '第 2 层和第 3 层初始菜肴以及在菜单中替换它们的能力'],
    [/^Triple(.+)Cook$/, '三重烹饪'],
    [/^Double(.+)Cook$/, '双重烹饪'],
    [/^(.+)Prestige Points.(.+)The cooking costs will be reset.(.+)Continue?$/, '声望点。 烹饪费用将被重置。 继续？'],
    [/^2(.+)and(.+)3(.+)starters$/, '2和3开始'],
    [/^Hard Reset(.+)\(right click or long hold$/, '硬重置（右键单击或长按'],
    [/^Sextuple(.+)Cook$/, '六重烹饪'],
