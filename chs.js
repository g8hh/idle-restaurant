...
var cnItems = {
    ...
    "When you Prestige, you restart the game with a bonus to income.": "当您获得声望时，您会以收入奖金重新开始游戏。",
    ...
    "300 + 5*(Restaurant Income).": "300 + 5*（餐厅收入）。",
    "Claim rewards": "收集奖励",
    "Warning": "警告",
    ...
    "Cook 1": "烹饪 1",
    "Main themes: Vegan, Dessert (doesn't affect anything outside that delivery": "主题：素食主义者，甜点（不影响交付之外的任何内容",
...
var cnRegReplace = new Map([
    ...
    [/^(.+)Prestige Points. The cooking costs will be reset. Continue?$/, '$1声望点。 烹饪费用将被重置。 继续？'],
    [/^Have (\d+)k$/, '拥有 $1k'],
    [/^Have (\d+)B$/, '拥有 $1k'],
    [/^Have (\d+)Qa$/, '拥有 $1k'],
    [/^Have (\d+)M$/, '拥有 $1M'],
